            ...
            <div class='main-content'>
                <div class="main-content-inner">
                    <div class="page-content">
                        ...
                        <form method="post" action="/WebSite_BanGiay/admin/addCustomer"  class="colorlib-form">
                            <div style="display: flex;align-items: center;margin-bottom: 12px;">
                                <div style="width: 110px;">Tên khách hàng</div>
                                <div><input style="width: 500px;"  name="tenKH" type="text" class="" required="true"></input></div>
                            </div>
                            <div style="display: flex;align-items: center;margin-bottom: 12px;">
                                <div style="width: 110px;">Giới tính</div>
                                <div><input style="width: 500px;"  name="gioiTinh" type="text" class="" required="true"></input></div>
                            </div>
                            <div style="display: flex;align-items: center;margin-bottom: 12px;">
                            ...
                            <div style="display: flex;align-items: center;margin-bottom: 12px;">
                                ...
                                <div><input style="width: 500px;"  name="email" type="text" class="" required="true"></input></div>
                            </div>
                            <div style="display: flex;align-items: center;margin-bottom: 12px;">
                                <div style="width: 110px;">Số điện thoại</div>
                                <div><input  style="width: 500px;" name="sdt" type="text" class="" ></input></div>
                            </div>
                            <div style="display: flex;align-items: center;margin-bottom: 12px;">
