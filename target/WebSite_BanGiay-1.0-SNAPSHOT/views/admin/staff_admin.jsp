                    ...
                    <div class="page-content">
                        ...
                        <div class="card border-info">
                            <div style="margin-bottom: 10px">
                                <a class="btn btn-primary" href="/WebSite_BanGiay/admin/addStaff">Thêm mới nhân viên</a>
                            </div>
                                    ...
                                    <c:forEach var="staff" items="${staffs}">
                                        <tr>
                                            ...
                                            <td style="color: white;">
                                                <a class="btn btn-warning" href="/WebSite_BanGiay/admin/editStaff/${staff.manv}">Sửa</a>
                                                <a class="btn btn-danger" href="/WebSite_BanGiay/admin/deleteStaff/${staff.manv}">Xóa</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
