<%-- 
    Document   : footer
    Created on : Apr 6, 2020, 10:38:27 AM
    Author     : Truong98
--%>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                <p>
                    ...
                    <span class="block">Demo ~/Content/images: <a href="http://unsplash.co/" target="_blank">Unsplash</a> , <a href="http://pexels.com/" target="_blank">Pexels.com</a></span>
                </p>
            </div>
        </div>
    </div>
